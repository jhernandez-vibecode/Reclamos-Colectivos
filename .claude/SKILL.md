...
- **🔑 El monto asegurado NO es el monto pagado.** En la VTM 805 el asegurado es siempre uno de los 5 escalones fijos (2/4/6/8/10M) y el pagado sale un poco menor (₡10.000.000 → ₡9,8–9,9M por ajustes del INS). **Si un caso tiene `montoAseg === montoInd` y el valor no es redondo, es un error de digitación**: se metió el pagado en la casilla del asegurado. Ese caso desaparece de su escalón y cae en la tajada gris **"Otro"** del gráfico de estadísticas, así que el escalón queda subcontado sin que nadie se dé cuenta. Corregido así el 19 ago 2026 en el caso #58222025000408 (`s27`, era ₡9.885.430 → ₡10.000.000; ₡10M pasó de 3 a 4 casos en 2025 y "Otro" desapareció). **No hacer que el gráfico redondee al escalón más cercano** — "Otro" es la alarma que destapa estos casos.
